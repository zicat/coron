...
import org.apache.calcite.sql.validate.CoronSqlValidatorImpl;
import org.apache.calcite.sql.validate.SqlConformanceEnum;
import org.apache.calcite.sql.validate.SqlValidator;
import org.apache.calcite.sql2rel.SqlToRelConverter;
import org.apache.calcite.tools.Frameworks;
import org.apache.calcite.util.Pair;
import org.zicat.coron.parser.sql.function.FunctionUtils;
import org.zicat.coron.parser.sql.type.UTF16JavaTypeFactoryImp;
import org.zicat.coron.parser.util.LockUtils;

import java.util.*;
import java.util.concurrent.locks.ReentrantReadWriteLock;

import static org.apache.calcite.linq4j.Nullness.castNonNull;
import static org.zicat.coron.parser.SqlNodeUtils.DEFAULT_DDL_PARSER_CONFIG;
import static org.zicat.coron.parser.SqlNodeUtils.DEFAULT_QUERY_PARSER_CONFIG;
...
public class CalciteContext {
    ...
    protected SqlValidator createValidator() {
        return CoronSqlValidatorImpl.newValidator(
                typeFactory,
                sqlOperatorTable,
    ...
    protected final <T> T writeLock(LockUtils.FunctionHandler<T> functionHandler) {
        return LockUtils.lock(functionHandler, lock.writeLock());
    }
    ...
    protected final <T> T readLock(LockUtils.FunctionHandler<T> functionHandler) {
        return LockUtils.lock(functionHandler, lock.readLock());
    }
}
