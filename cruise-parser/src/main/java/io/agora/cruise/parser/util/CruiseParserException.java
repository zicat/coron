...
/** CruiseParserException. */
public class CruiseParserException extends RuntimeException {

    /**
     * Constructs a new runtime exception with {@code null} as its detail message. The cause is not
     * initialized, and may subsequently be initialized by a call to {@link #initCause}.
     */
    public CruiseParserException() {
        super();
    }
     ...
     */
    public CruiseParserException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public CruiseParserException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public CruiseParserException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected CruiseParserException(
            String message,
            Throwable cause,
